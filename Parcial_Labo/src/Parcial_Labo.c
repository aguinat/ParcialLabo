...
int main(void) {
	...
	eCliente Cliente[TAM]={{5,"Google",1234567891,"Iriarte 40",1 ,0},{2,"McDonalds",147852369,"Junin 200",1 ,0},{3,"Apple",17823456,"Lima 820",2,0}};

	//ePedido Pedido [TAM];
	ePedido Pedido [TAM] ={{1,5,"Completado",12.2, 6.3, 7.2, 7.2,0},{2,5,"Completado",20.65,  6.3, 7.2, 3.5,0},{3,5,"Pendiente", 50.2, 6.3, 7.2, 20.5,0},{1,3,"Pendiente",12.2, 6.3, 7.2, 15.5,0},
	...
	do {
			...
			if (opcionCorrecta == 1) {
				...
				case 2:
					...
					break;
				case 3:
					DarClienteDeBaja(Cliente, TAM, REIN, Localidades, TAM, Pedido, TAM );
					break;
				case 4:
				...
				case 5:
					...
					break;
				case 6:
					MostrarCantidadPedidosCliente(Pedido, TAM, Cliente, TAM, Localidades, TAM);
					break;
				case 7:
					MostrarPedidosPorEstado(Pedido, TAM, Cliente, TAM, "Pendiente");
					break;
				case 8:
					MostrarPedidosPorEstado(Pedido, TAM, Cliente, TAM, "Completado");
					break;
				case 9:
				...
				case 10:
					...
					break;
				case 11:
					CalcularPedidosCliente(Pedido, TAM, Cliente, TAM, "Pendiente");
					break;
				case 12:
					CalcularPedidosCliente(Pedido, TAM, Cliente, TAM,"Completado");
					break;
				case 13:
					CalcularPedidosCliente(Pedido, TAM, Cliente, TAM, "");
					break;
