...
int main(void) {
	...
	eLocalidad entidadlocalidad[TAM] = {{"caba"},{"lujan"},{"lanus"}};
	eCliente Cliente[TAM]={{1,"NuevaEmp",1234567891,"unLugar 40",entidadlocalidad[0],0},{2,"OtraEmpresa",147852369,"OtroLugar 200",entidadlocalidad[1] ,0},{3,"Apple",17823456,"Lima 820",entidadlocalidad[2] ,0}};
	printf("%s", Cliente[0].entidadlocalidad);
	//ePedido Pedido [TAM];
	ePedido Pedido [TAM] ={{1,1,"Completado",12.2, 6.3, 7.2, 7.2,0},{2,1,"Completado",20.65,  6.3, 7.2, 3.5,0},{3,2,"Completado",50.2,  6.3, 7.2, 20.5,0},{1,2,"Pendiente",12.2, 6.3, 7.2, 15.5,0},
